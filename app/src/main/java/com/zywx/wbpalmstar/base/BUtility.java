package com.zywx.wbpalmstar.base;
...
public class BUtility {
    ...
    public static InputStream compress(Context m_eContext, String path,
        ...
        if (scaleRate != 1) {
            ...
            options.inPreferredConfig = Bitmap.Config.RGB_565;// 会失真，缩略图失真没事^_^
            ...
            if (source != null) {
                ...
                if (dstbmp.compress(Bitmap.CompressFormat.JPEG, quality, baos)) {
